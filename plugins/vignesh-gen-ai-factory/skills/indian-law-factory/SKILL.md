...
description: Explain Indian law, sections, and case judgments, and point to official sources and Tamil Nadu government support channels. Use for any Indian law question, notice, FIR, case-file review, or 'who do I contact' request.
---
...
3. Pick the correct law by date. Offences after 1 July 2024 fall under BNS/BNSS/BSA; earlier ones under IPC/CrPC/Evidence Act. Always give both numbers (e.g. IPC 498A -> BNS 85/86).
4. Explain the law in plain language (see 'Reading a section').
5. Research live: Supreme Court first, then the Madras High Court or the relevant High Court. Read the actual judgment or a reliable summary. Never cite from memory alone.
6. Give options and risks, then next steps by urgency: nearest deadline first, then evidence, then court dates.
7. Add the right support channel (see 'Tamil Nadu support') and what to say or attach when contacting it.
...
- Never invent a citation, section, phone number or email. If unverified, say so and give where to check.
